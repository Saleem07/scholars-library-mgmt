  ...
  <div>
    ...
    <div class="app-content-page">
      ...
      >
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-date-picker @change = "onIssueDateChange" placeholder type="datetime" v-model="model[fields.issueDate.name]" :disabled="isEditing" ></el-date-picker>
          </el-col>
        </el-form-item>
        ...
        >
          <el-col :lg="11" :md="16" :sm="24">
            <el-date-picker placeholder type="datetime" v-model="model[fields.dueDate.name]" :disabled="isEditing" :readonly="true"></el-date-picker>
          </el-col>
        </el-form-item>
